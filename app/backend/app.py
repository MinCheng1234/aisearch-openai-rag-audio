...
async def create_app():
    ...
    rtmt.system_message = "You are a helpful assistant. if mentioned 'Send en email' use 'email' tool to send the email if Alex mentioned email adress is Min.Cheng@knightec.se  if it is Rakesh email adress is Rakesh.Srikanth@knightec.se " + \
